...
<head>
  ...
  <link rel="stylesheet" href="{html.escape(stylesheet)}?v=20260825-2">
  <script>try{{document.documentElement.dataset.theme=localStorage.getItem('leaf-doc-theme')||''}}catch(e){{}}</script>
</head>
<body data-search-index="{html.escape(search_index)}" data-docs-home="{html.escape(docs_home)}">
  ...
  <script src="{html.escape(script)}?v=20260825-2" defer></script>
</body>
</html>
"""
